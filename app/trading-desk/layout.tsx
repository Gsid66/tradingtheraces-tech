...
function TradingDeskLayoutClient({ children, isAuthenticated }: TradingDeskLayoutProps) {
...
export default async function TradingDeskLayout({
  ...
  return (
    <TradingDeskLayoutClient isAuthenticated={isAuthenticated}>
      {children}
    </TradingDeskLayoutClient>
  );
}
