...
export default function UploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/ttr-au-nz-ratings/upload', {
        method: 'POST',
        body: formData,
      });
      ...
      if (data.success && data.raceDates && data.raceDates.length > 0) {
        ...
        // setTimeout(() => {
        //   router.push(`/ttr-au-nz-ratings/${data.raceDates[0]}`);
        // }, 2000);
      }
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            Upload TTR AU/NZ Ratings
          </h1>
          <p className="text-gray-600">
            Upload a CSV file containing TTR Australia & New Zealand racing ratings data
          </p>
        </div>

        {/* Instructions */}
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
          <h3 className="text-lg font-semibold text-green-900 mb-3">CSV Format Requirements</h3>
          <div className="text-sm text-green-800 space-y-2">
            <p><strong>Required columns (tab-separated):</strong></p>
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li><strong>Date:</strong> Format: &quot;Friday, 14th November 2025&quot; or &quot;14/11/2025&quot;</li>
              <li><strong>Track:</strong> Track name (e.g., &quot;Flemington&quot;, &quot;Randwick&quot;)</li>
              ...
              <li><strong>Rating:</strong> Rating value (optional, integer)</li>
              <li><strong>Price:</strong> Format: &quot;$2.36&quot; (optional)</li>
            </ul>
            <p className="mt-3"><strong>Note:</strong> AU/NZ data is typically <strong>tab-delimited</strong>, not comma-separated.</p>
          </div>
        </div>
