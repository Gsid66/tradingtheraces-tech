...
import { FaCrown, FaGlobeAsia, FaGlobeEurope, FaChartLine, FaCodeBranch, FaChartBar, FaMagic } from 'react-icons/fa'
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="coming-soon-grid mt-12">
        <Link href="/merged-ratings" className="coming-soon-card">
          <div className="coming-soon-icon">
            <FaCodeBranch />
          </div>
          <h4>Available Now!</h4>
          <p>Merged Ratings (RVO + TTR)</p>
        </Link>
        <div className="coming-soon-card">
          ...
          <h4>Coming Soon</h4>
          <p>Advanced Analysis (Decoding The Data)</p>
        </div>
        <div className="coming-soon-card">
          <div className="coming-soon-icon">
            <FaMagic />
