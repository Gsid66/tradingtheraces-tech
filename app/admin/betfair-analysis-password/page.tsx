...
export default function BetfairAnalysisPasswordPage() {
  ...
  const updatePassword = async () => {
    ...
    try {
      const response = await fetch('/api/betfair-analysis/admin/update-password', {
        method: 'POST',
      ...
      <div className="bg-slate-800 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold">Betfair Analysis Password Manager</h1>
              <p className="text-slate-300 mt-2">
                Manage user access password for Betfair Results analysis
              </p>
            </div>
            <Link
              href="/admin"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li>
                <span className="text-gray-700 font-medium">Betfair Analysis Password</span>
              </li>
            </ol>
          </nav>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent text-gray-900"
            ...
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-blue-800">
                ...
                <li>Users can log in at <strong>/betfair-analysis</strong></li>
              </ol>
            </div>
          </div>
        </div>
