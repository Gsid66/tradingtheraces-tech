  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 py-6 sm:py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <NavigationLink href="/form-guide">
          <div className="bg-black/60 rounded-lg p-5 sm:p-8 text-center hover:bg-black/80 hover:border-2 hover:border-purple-400 hover:shadow-lg hover:shadow-purple-500/50 transition-all cursor-pointer border-2 border-purple-500 shadow-lg shadow-purple-500/30">
        ...
        <NavigationLink href="/ttr-uk-ire-ratings">
          <div className="bg-black/60 rounded-lg p-5 sm:p-8 text-center hover:bg-black/80 hover:border-2 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/50 transition-all cursor-pointer border-2 border-red-600 shadow-lg shadow-red-500/30">
        ...
        <NavigationLink href="/ttr-uk-ire-ratings">
          <div className="bg-black/60 rounded-lg p-5 sm:p-8 text-center hover:bg-black/80 hover:border-2 hover:border-green-400 hover:shadow-lg hover:shadow-green-500/50 transition-all cursor-pointer border-2 border-green-500 shadow-lg shadow-green-500/30">
        ...
        <NavigationLink href="/ttr-au-nz-ratings">
          <div className="bg-black/60 rounded-lg p-5 sm:p-8 text-center hover:bg-black/80 hover:border-2 hover:border-amber-400 hover:shadow-lg hover:shadow-amber-500/50 transition-all cursor-pointer border-2 border-amber-500 shadow-lg shadow-amber-500/30">
        ...
        <NavigationLink href="/calculator">
          <div className="bg-black/60 rounded-lg p-5 sm:p-8 text-center hover:bg-black/80 hover:border-2 hover:border-purple-400 hover:shadow-lg hover:shadow-purple-500/50 transition-all cursor-pointer border-2 border-purple-500 shadow-lg shadow-purple-500/30">
        ...
        <NavigationLink href="/merged-ratings">
          <div className="bg-black/60 rounded-lg p-5 sm:p-8 text-center hover:bg-black/80 hover:border-2 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-500/50 transition-all cursor-pointer border-2 border-cyan-500 shadow-lg shadow-cyan-500/30">
        ...
        <NavigationLink href="/betfair-analysis">
